...
#include "MultiplayerDemoWheelFront.h"
#include "MultiplayerDemoWheelRear.h"
...
const FName AMultiplayerDemoPawn::LookUpBinding("LookUp");
const FName AMultiplayerDemoPawn::LookRightBinding("LookRight");
const FName AMultiplayerDemoPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

PRAGMA_DISABLE_DEPRECATION_WARNINGS

AMultiplayerDemoPawn::AMultiplayerDemoPawn()
{
	// Car mesh
	...
	{
		VehicleMovement->WheelSetups[0].WheelClass = UMultiplayerDemoWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[1].WheelClass = UMultiplayerDemoWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[2].WheelClass = UMultiplayerDemoWheelRear::StaticClass();
		...
		VehicleMovement->WheelSetups[3].WheelClass = UMultiplayerDemoWheelRear::StaticClass();
...
void AMultiplayerDemoPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AMultiplayerDemoPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AMultiplayerDemoPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &AMultiplayerDemoPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &AMultiplayerDemoPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AMultiplayerDemoPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AMultiplayerDemoPawn::OnResetVR); 
}

void AMultiplayerDemoPawn::MoveForward(float Val)
{
	if (Val > 0)
	{
...
void AMultiplayerDemoPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AMultiplayerDemoPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AMultiplayerDemoPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AMultiplayerDemoPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AMultiplayerDemoPawn::EnableIncarView(const bool bState)
{
...
void AMultiplayerDemoPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AMultiplayerDemoPawn::BeginPlay()
{
	Super::BeginPlay();
...
void AMultiplayerDemoPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void AMultiplayerDemoPawn::UpdateHUDStrings()
{
...
void AMultiplayerDemoPawn::SetupInCarHUD()
{
...
void AMultiplayerDemoPawn::UpdatePhysicsMaterial()
{
